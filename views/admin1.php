...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
			...
			-->	<a href="<?php echo base_url();?>admin1/change/<?php echo $a->id;?>" class="btn btn-warning"  data-target="#edit-pass"><i class="fa fa-pencil" target="_blank"></i> Change Password</a>
